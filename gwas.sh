...
file_pheno="/ifs/sec/cpc/addhealth/users/adamg93/pheno"

#Enter the name of your outcome variable
outcome_variable="bmi"

#Enter the name of your covariates
covariate_variable="race+bio.sex4+age2+weights"
...
output_wd="/ifs/sec/cpc/addhealth/users/adamg93/"
...
dir_vcf="/ifs/sec/cpc/addhealth/gwas/final/1KG/rmfiles"
id_col="gpairid_aid"
fam_col="gfam"
...
do
	...
	do	
		...
		echo "${cmd} --mem=4g -t 4-00:00:00 -n 2 -o ${file_lsflog} --wrap=\"${software} --pheno ${file_pheno} --id-col ${id_col} --family-col ${fam_col} --vcf ${file_vcf} --formula ${formula} --unweighted --hetero-variance race --out-prefix ${trait}.chr${chr}RM --dosage\"" >> ${file_submit}
	done
done
